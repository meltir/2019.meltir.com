 ...
 */
final class Version20190524155426 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE imdb_movies ADD synopsis VARCHAR(255) DEFAULT NULL, DROP trailer, CHANGE my_rating my_rating INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE imdb_movies ADD trailer VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, DROP synopsis, CHANGE my_rating my_rating INT DEFAULT NULL');

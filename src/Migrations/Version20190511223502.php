 ...
 */
final class Version20190511223502 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE yt_channels CHANGE chan_description chan_description LONGTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE yt_channels CHANGE chan_description chan_description VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}

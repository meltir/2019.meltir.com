 ...
 */
final class Version20190524160635 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE imdb_movies CHANGE my_rating my_rating INT DEFAULT NULL, CHANGE synopsis synopsis LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE imdb_movies CHANGE my_rating my_rating INT DEFAULT NULL, CHANGE synopsis synopsis VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
